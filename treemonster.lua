...
foodchain:register_mob("foodchain:tree_monster", {
	type = "monster",
	passive = false,
...
foodchain:register_spawn("foodchain:tree_monster", {"default:leaves", "default:jungleleaves"}, 5, 0, 7000, 1, 31000)

foodchain:register_egg("foodchain:tree_monster", "Tree Monster", "default_tree_top.png", 1)
